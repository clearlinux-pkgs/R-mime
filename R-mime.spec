...
Version  : 0.11
Release  : 86
URL      : https://cran.r-project.org/src/contrib/mime_0.11.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mime_0.11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624487589
