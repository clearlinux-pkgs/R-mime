...
Version  : 0.9
Release  : 78
URL      : https://cran.r-project.org/src/contrib/mime_0.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mime_0.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589507217
