...
Version  : 0.13
Release  : 105
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/mime_0.13.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/mime_0.13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742435653
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/mime/libs/mime.so
/V4/usr/lib64/R/library/mime/libs/mime.so
